            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input
                      className="input-class focus-visible:ring-offset-orange-1 focus-visible:ring-0"
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                <SelectContent className="text-16 border-none bg-black-1 text-white-1 font-bold">
                  {voiceCategories.map((category) => (
                    <SelectItem key={category} value={category} className=" focus:bg-orange-1">{category}
                    </SelectItem>
                  ))}
                </SelectContent>
                {voiceType && (
