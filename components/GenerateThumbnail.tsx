    ...
    {isAiThumbnail ? (
      <div className='flex flex-col gap-5'>
        <div className="flex flex-col gap-2.5 mt-5">
          ...
          <Textarea
            className="input-class font-light focus-visible:ring-offset-orange-1 focus-visible:ring-0"
        ...
        <div className="w-full max-w-[200px] ">
          <Button
            type="submit"
            className="text-16 bg-orange-1 py-4 font-bold text-white-1" onClick={generateImage}
          >
            {isImageLoading? (
              <>
                Image Uploading                
